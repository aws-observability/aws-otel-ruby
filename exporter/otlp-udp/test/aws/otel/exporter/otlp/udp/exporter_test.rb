...
describe AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter do
  let(:success) { OpenTelemetry::SDK::Trace::Export::SUCCESS }
  let(:endpoint) { 'localhost:3000' }
  let(:host) { 'localhost' }
  let(:port) { 3000 }
  let(:udp_exporter) { AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter.new(endpoint) }
  ...
  def test_send_udp_data_correctly
    ...
    UDPSocket.stub :new, mock_socket do
      exporter = AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter.new(endpoint)
  ...
  def test_throw_when_provided_invalid_endpoint
    assert_raises(StandardError, 'Invalid endpoint: 123') do
      AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter.new(123)
    end
  end
end

describe AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::AWSXRayUDPSpanExporter do
  let(:success) { OpenTelemetry::SDK::Trace::Export::SUCCESS }
  let(:endpoint) { 'localhost:3001' }
  let(:xray_udp_span_exporter) { AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::AWSXRayUDPSpanExporter.new(endpoint) }
  ...
  def test_export_spans_successfully
    ...
    result = -1
    AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter.stub :new, mock_exporter do
      exporter = AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::AWSXRayUDPSpanExporter.new(endpoint, prefix)
  ...
  def test_force_flush_without_error
    xray_udp_span_exporter.force_flush
  end
  ...
  def test_shutdown_udp_exporter_successfully
    ...
    AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::UdpExporter.stub :new, mock_exporter do
      exporter = AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::AWSXRayUDPSpanExporter.new(endpoint)
      exporter.shutdown
    end
  ...
  def test_use_expected_environment_variables_to_configure_endpoint
    ...
    exporter = AWS::Distro::OpenTelemetry::Exporter::XRay::UDP::AWSXRayUDPSpanExporter.new
